---
title: "Organizing and Running an Event Full of Big YouTubers"
date: 2026-02-09T11:30:03+00:00
# weight: 1
# aliases: ["/first"]
tags: ["minecraft", "event", "speedrunning"]
author: "Me"
showToc: true
TocOpen: false
draft: false
...
![Event Logo](/images/logoCDB.jpg)

I've been organizing and running these types of events for more than **5 years** now, and I [wrote about it here already](/posts/mcsr-5-anos). In **October 2025**, I got a message from someone called **Pancks**, asking if I could help him organize a tournament called Corrida Dos Bobos.
...
![Initial Message](/images/printcdb1.png)
...
![Final Bracket](/images/cdbbracket.png)
...
![Message saying that we might need to delay the event](/images/cdbtreinadores.png)
...
<p style="text-align: center; opacity: 0.7; font-size: 0.9em;">Starting Soon scene</p>
...
<p style="text-align: center; opacity: 0.7; font-size: 0.9em;">Spinning Wheel</p>
...
<p style="text-align: center; opacity: 0.7; font-size: 0.9em;">Interview scene</p>
...
<p style="text-align: center; opacity: 0.7; font-size: 0.9em;">End celebration</p>
...
![Splits screen](/images/splitscreen.png)

The flow of each match on stream went like this:

1. **Starting Soon** screen stays up until everything is ready
2. Ask **Lena** (our Cameragirl) to move to the presentation area
3. We introduce ourselves, announce the upcoming match, answer any questions, then say we're spinning the wheel
4. Lena flies to the seed choice area, and I "spin the wheel"
5. Explain anything necessary about the seed, then switch to the match overlay (no Minecraft background)
6. Lena flies back to the presentation area, ready for the post-match interview
7. After the match ends, we show a **splits screen** with both players and break down the run. Meanwhile, coaches are telling the runners to join the server for the interview
8. Switch to the **interview scene**, talk about the match, then go back to the Starting Soon screen for about 5 minutes while we set up the next one
...
![rOBS](/images/robson.png)

[Link to rOBS GitHub repo](https://github.com/Tchongas/MCSRobsremote)
...
![Stream Stats](/images/stats1.png)

Twitch stream summary:
Day 1: 
![Stream Stats](/images/stats2.png)
Day 2:
![Stream Stats](/images/stats3.png)
...
Vods links:
- [CORRIDA DOS BOBOS](https://www.youtube.com/@MinecraftSpeedrunBrasil/streams)
